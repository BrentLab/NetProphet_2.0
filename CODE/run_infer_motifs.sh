...
python /scratch/mblab/dabid/netprophet/code_netprophet2.1/CODE/parse_network_scores.py -a $NETWORK -r $REGULATORS -t $GENES -o ${OUTPUT_DIR}motif_inference/network_scores/
python /scratch/mblab/dabid/netprophet/code_netprophet2.1/CODE/parse_quantized_bins.py -n 20 -i ${OUTPUT_DIR}motif_inference/network_scores/ -o ${OUTPUT_DIR}motif_inference/network_bins/
printf "DONE\n"
...
export FIREDIR=/scratch/mblab/dabid/netprophet/code_netprophet2.0/SRC/FIRE-1.1a
	/scratch/mblab/dabid/netprophet/code_netprophet2.1/CODE/infer_motifs.sh $REGULATORS $PROMOTER ${OUTPUT_DIR}motif_inference/network_bins/ ${OUTPUT_DIR}motif_inference/motif_inference.log
fi
