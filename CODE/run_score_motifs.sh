...
for f in ${TF_LIST}/*; do
	TF_SUBLIST=$f;
	sbatch CODE/score_motifs.sh $TF_SUBLIST $OUTPUT_DIR/motif_inference/motifs_pfm/ $PROMOTERS $OUTPUT_DIR/motif_inference/motifs_score ${OUTPUT_DIR}/motif_inference/motif_scoring.log;
done
