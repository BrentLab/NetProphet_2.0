...
p_in_de=${p_wd}net_in/sub2_kem_de_pvalues_151_6023
p_dbd_pid=${p_wd}net_in/DBD_PIDS
p_in_promoter=${p_wd}net_in/promoter.scer.fasta

# output variables
p_out_dir=${p_wd}net_out/kem_netprophet2/
p_out_tmp=${p_out_dir}tmp/
p_out_net=${p_out_dir}networks/

p_in_expr_reg=${p_out_tmp}kem_expr_reg_151_1485
p_in_fc=${p_out_tmp}kem_fc
